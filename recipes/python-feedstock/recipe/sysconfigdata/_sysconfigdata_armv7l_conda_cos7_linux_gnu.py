...
build_time_vars = {'ABIFLAGS': '@ABIFLAGS@',
 ...
 'ANDROID_API_LEVEL': 0,
 'AR': 'armv7-conda_cos7-linux-gnueabihf-ar',
 'ARFLAGS': 'rcs',
 ...
 'BLDSHARED': 'armv7-conda_cos7-linux-gnueabihf-gcc -pthread -shared -Wl,-O2 '
 ...
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'armv7-conda_cos7-linux-gnueabihf',
 'BYTESTR_DEPS': '\\',
 'CC': 'armv7-conda_cos7-linux-gnueabihf-gcc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -fwrapv -O3 -Wall '
           '-march=armv7-a -mfpu=vfpv3-d16 -ftree-vectorize -fPIC '
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-march=armv7-a -mfpu=vfpv3-d16 -ftree-vectorize -fPIC '
                     '-fstack-protector-strong -fno-plt -O2 ',
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            '-Wno-unused-parameter '
                            '-Wno-missing-field-initializers ',
 'CONFIGURE_CPPFLAGS': '-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 '
 ...
 'CONFIG_ARGS': "'--prefix=/opt/anaconda1anaconda2anaconda3' "
                "'--build=armv7-conda_cos7-linux-gnueabihf' "
                "'--host=armv7-conda_cos7-linux-gnueabihf' '--enable-ipv6' "
                ...
                "-ltcl8.6 -ltk8.6' "
                "'--disable-shared' "
                "'build_alias=armv7-conda_cos7-linux-gnueabihf' "
                "'host_alias=armv7-conda_cos7-linux-gnueabihf' "
                "'CC=armv7-conda_cos7-linux-gnueabihf-gcc' "
                "'CFLAGS=-march=armv7-a -mfpu=vfpv3-d16 -ftree-vectorize -fPIC "
                ...
                "-I/opt/anaconda1anaconda2anaconda3/include' "
                "'CPP=armv7-conda_cos7-linux-gnueabihf-cpp' "
 ...
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             ...
             '-D_FORTIFY_SOURCE=2 -O2 '
             '-I/opt/anaconda1anaconda2anaconda3/include',
 'CXX': 'armv7-conda_cos7-linux-gnueabihf-c++ -pthread',
 ...
 'EXEMODE': 755,
 'EXTRATESTOPTS': '',
 'EXT_SUFFIX': '.cpython-@PYVERNODOTS@@ABIFLAGS@-arm-linux-gnueabihf.so',
 'FILEMODE': 644,
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'armv7-conda_cos7-linux-gnueabihf',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'armv7-conda_cos7-linux-gnueabihf-c++ -pthread -shared',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'armv7-conda_cos7-linux-gnueabihf-gcc -pthread -shared -Wl,-O2 '
             '-Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now '
             '-Wl,--disable-new-dtags -Wl,--gc-sections '
             '-Wl,-rpath,/opt/anaconda1anaconda2anaconda3/lib '
             '-Wl,-rpath-link,/opt/anaconda1anaconda2anaconda3/lib '
 ...
 'LIBPL':
     '/opt/anaconda1anaconda2anaconda3/lib/python3.7/config-@PYVER@@ABIFLAGS@-arm-linux-gnu',
 'LIBRARY': 'libpython@PYVER@@ABIFLAGS@.a',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lcrypt -lpthread -ldl  -lutil',
 'LIBSUBDIRS': 'tkinter tkinter/test tkinter/test/test_tkinter \\',
 'LINKCC': 'armv7-conda_cos7-linux-gnueabihf-gcc -pthread',
 ...
 'MAINCC': 'armv7-conda_cos7-linux-gnueabihf-gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '/root/conda-bld/python_1562522701450/work/Modules/makesetup',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG '
                             '-fwrapv -O3 -Wall -march=armv7-a -mfpu=vfpv3-d16 '
                             '-ftree-vectorize -fPIC -fstack-protector-strong '
                             '-fno-plt -O2 -ffunction-sections -pipe  '
                             '-march=armv7-a -mfpu=vfpv3-d16 -ftree-vectorize '
                             ...
                             '-IInclude -IPython -I. '
                             '-I/root/conda-bld/python_1562522701450/work/Include '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -fwrapv -O3 '
                   '-Wall -march=armv7-a -mfpu=vfpv3-d16 -ftree-vectorize '
                   '-fPIC -fstack-protector-strong -fno-plt -O2 '
                   '-ffunction-sections -pipe  '
                   '-march=armv7-a -mfpu=vfpv3-d16 -ftree-vectorize -fPIC '
                   '-fstack-protector-strong -fno-plt -O2 -ffunction-sections '
 ...
 'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. '
                '-I/root/conda-bld/python_1562522701450/work/Include -DNDEBUG '
                '-D_FORTIFY_SOURCE=2 -O2 '
                '-I/opt/anaconda1anaconda2anaconda3/include '
                '-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 '
                '-I/opt/anaconda1anaconda2anaconda3/include',
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -fwrapv '
                        '-O3 -Wall -march=armv7-a -mfpu=vfpv3-d16 '
                        '-ftree-vectorize -fPIC -fstack-protector-strong '
                        '-fno-plt -O2 -ffunction-sections -pipe  '
                        '-march=armv7-a -mfpu=vfpv3-d16 -ftree-vectorize -fPIC '
                        '-fstack-protector-strong -fno-plt -O2 '
 ...
 'READELF': 'armv7-conda_cos7-linux-gnueabihf-readelf',
 ...
 'SRC_GDB_HOOKS': '/root/conda-bld/python_1562522701450/work/Tools/gdb/libpython.py',
 'STDC_HEADERS': 1,
 ...
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': './python '
               '/root/conda-bld/python_1562522701450/work/Tools/scripts/run_tests.py',
 'TESTTIMEOUT': 1200,
 'TIMEMODULE_LIB': 0,
 ...
 'VERSION': '3.7',
 'VPATH': '/root/conda-bld/python_1562522701450/work',
 'WINDOW_HAS_FLAGS': 1,
 'WITH_DOC_STRINGS': 1,
 'WITH_DTRACE': 0,
 'WITH_DYLD': 0,
 ...
 'abs_builddir': '/root/conda-bld/python_1562522701450/work/build-shared',
 'abs_srcdir': '/root/conda-bld/python_1562522701450/work',
 ...
 'srcdir': '/root/conda-bld/python_1562522701450/work'}
